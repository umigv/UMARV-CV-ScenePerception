...
class hsv:
    ...
    def load_hsv_values(self):
        if os.path.exists(self.hsv_file):
            with open(self.hsv_file, 'r') as file:
                ...
                self.h_upper = hsv_values.get('h_upper', self.h_upper)
                self.h_lower = hsv_values.get('h_lower', self.h_lower)
                self.s_upper = hsv_values.get('s_upper', self.s_upper)
                self.s_lower = hsv_values.get('s_lower', self.s_lower)
                self.v_upper = hsv_values.get('v_upper', self.v_upper)
                self.v_lower = hsv_values.get('v_lower', self.v_lower)
    ...
    def save_hsv_values(self):
        ...
        with open(self.hsv_file, 'w') as file:
